...
export const penWorld: Project = {
  ...
  cover: {
    ...
    alt: "Pen World featured-product and product-detail screens on two phones over a dark background",
    width: 1600,
    height: 1200,
  },
  screens: [
    phone("home", "Pen World home screen: NEW! badge, the Cross Bailey Light fountain pen as the featured product and a Shop Now button", "Home — one featured product, one action"),
    phone("product", "Product detail: Cross Bailey Light Polished Black Resin Gold Plated, availability, description, price in Rs, quantity, Buy Now and Add to Cart", "Product detail — availability, price and two clear actions"),
  ],
  wireframes: [],
  overview:
  ...
  designSystem: {
    ...
    notes: ["Colour and type values are read from the Figma file. Display faces (Lemon, Lalezar) are used only for the brand mark and the NEW badge; League Spartan carries all UI text."],
  ...
  outcome: {
    ...
    items: ["Home, product detail, cart and checkout screens in Figma", "Custom product assets", "Editable Figma source handed to the client"],
